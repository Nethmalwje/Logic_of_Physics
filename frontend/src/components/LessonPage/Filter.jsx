...
const Filter = () => {
  const LessonData = [
    { lessonid: 1, lesson_name: "Introduction to Design Principles" },
    { lessonid: 2, lesson_name: "Advanced Illustration Techniques" },
    { lessonid: 3, lesson_name: "Mastering Iconography" },
    { lessonid: 4, lesson_name: "Plugin Development Basics" },
    { lessonid: 5, lesson_name: "Exploring Color Palettes" },
  ];
  return (
    <div>
      <div>
